...
public class MediaNota {
	...
	public static void main(String[] args) {
		...
		if (media >= 90) {
			JOptionPane.showMessageDialog(null, "Estrela Dourada! Sua media e " + media);
		} else if (media >= 50) {
			JOptionPane.showMessageDialog(null, "Estrela Prateada! Sua media e " + media);
		} else {
			JOptionPane.showMessageDialog(null, "Nao ganha estrela! Sua media e " + media);
		}
	}
}
